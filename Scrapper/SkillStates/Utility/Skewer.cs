...
public class Skewer : LoaderMeleeAttack
{
	...
	public override void OnEnter()
	{
		...
		if (base.isAuthority)
		{
			...
			base.characterMotor.disableAirControlUntilCollision |= Skewer.disableAirControlUntilCollision;
			this.punchVelocity = Skewer.CalculateLungeVelocity(base.characterMotor.velocity, base.GetAimRay().direction, this.charge, this.minLungeSpeed, this.maxLungeSpeed);
			base.characterMotor.velocity = this.punchVelocity;
			base.characterDirection.forward = base.characterMotor.velocity.normalized;
			this.punchSpeed = base.characterMotor.velocity.magnitude;
			this.bonusDamage = this.punchSpeed * (Skewer.velocityDamageCoefficient * base.damageStat);
		}
	}
	...
	{
		base.PlayAnimation();
		base.PlayAnimation("FullBody, Override", Skewer.ChargePunchStateHash, Skewer.ChargePunchParamHash, base.duration);
	}
	...
	{
		base.OnExit();
		base.characterMotor.velocity *= Skewer.speedCoefficientOnExit;
	}
