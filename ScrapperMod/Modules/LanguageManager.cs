...
namespace Scrapper.Modules
{
    internal static class LanguageManager
    {
        ...
        {
            var path = Path.Combine(Path.GetDirectoryName(ScrapperPlugin.instance.Info.Location), "Language");
        ...
        public static void PrintOutput(string fileName = "")
        {
            ...
            {
                var path = Path.Combine(Directory.GetParent(ScrapperPlugin.instance.Info.Location).FullName, "Language", "en", fileName);
