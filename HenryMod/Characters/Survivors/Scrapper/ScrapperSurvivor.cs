...
using ScrapperMod.Modules.Characters;
using ScrapperMod.Survivors.Scrapper.Components;
using ScrapperMod.Survivors.Scrapper.SkillStates;
using RoR2;
using RoR2.Skills;
...
namespace ScrapperMod.Survivors.Scrapper
{
    public class ScrapperSurvivor : SurvivorBase<ScrapperSurvivor>
    {
        ...
        public override UnlockableDef characterUnlockableDef => ScrapperUnlockables.characterUnlockableDef;
        ...
        public override void InitializeCharacter()
        {
            ...
            ScrapperAssets.Init(assetBundle);
            ScrapperBuffs.Init(assetBundle);
        ...
        public override void InitializeCharacterMaster()
        {
            ...
            ScrapperAI.Init(bodyPrefab, masterName);
