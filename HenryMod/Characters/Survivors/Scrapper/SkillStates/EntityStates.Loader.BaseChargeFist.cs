...
public class BaseChargeFist : BaseSkillState
{
	...
	public override void FixedUpdate()
	{
		...
		if (this.charge >= BaseChargeFist.minChargeForChargedAttack && !this.chargeVfxInstanceTransform && (bool)BaseChargeFist.chargeVfxPrefab)
		{
			if ((bool)BaseChargeFist.crosshairOverridePrefab && this.crosshairOverrideRequest == null)
			{
			...
			if ((bool)transform)
			{
				this.chargeVfxInstanceTransform = UnityEngine.Object.Instantiate(BaseChargeFist.chargeVfxPrefab, transform).transform;
